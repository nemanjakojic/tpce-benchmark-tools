...
void CCETxnMixGenerator::UpdateTunables( void )
{
    ...
    m_CETransactionMixTotal =
		...
		m_pDriverCETxnSettings->TxnMixGenerator_settings.cur.TradeResultMixLevel +
	...
	TradeResultMixLimit = m_pDriverCETxnSettings->TxnMixGenerator_settings.cur.TradeResultMixLevel + BrokerVolumeMixLimit;
	...
	for (; i < TradeResultMixLimit; ++i)
    {
        m_pTxnArray[i] = TRADE_RESULT;
    }
