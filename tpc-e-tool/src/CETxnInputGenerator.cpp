...
void CCETxnInputGenerator::GenerateTradeResultInput(TTradeResultTxnInput &TxnReq)
{	
	TxnReq.Clear();
	TxnReq.trade_id = GenerateNonUniformTradeID(TradeLookupAValueForTradeIDGenFrame1,
                                                TradeLookupSValueForTradeIDGenFrame1);
	TxnReq.trade_price = m_rnd.RndDoubleIncrRange(fMinSecPrice, fMaxSecPrice, 0.01);
}
